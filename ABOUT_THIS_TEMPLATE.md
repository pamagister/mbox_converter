...
├── mbox_converter             # The main python package for the project
...
e.g: `cat mbox_converter/VERSION` will get the project version without harming
...
- 🎯 Entry points to execute your program using `python -m <mbox_converter>` or `$ mbox_converter` with basic CLI argument parsing.
...
[![codecov](https://codecov.io/gh/pamagister/mbox_converter/branch/main/graph/badge.svg?token=mbox_converter_token_here)](https://codecov.io/gh/pamagister/mbox_converter)
[![CI](https://github.com/pamagister/mbox_converter/actions/workflows/main.yml/badge.svg)](https://github.com/pamagister/mbox_converter/actions/workflows/main.yml)

Awesome mbox_converter created by pamagister

## Install it from PyPI

```bash
pip install mbox_converter
```

## Usage

```py
from mbox_converter import BaseClass
from mbox_converter import base_function
