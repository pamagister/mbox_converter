...
- Clone your fork of this repo. `git clone git@github.com:YOUR_GIT_USERNAME/mbox_converter.git`
- Enter the directory `cd mbox_converter`
- Add upstream repo `git remote add upstream https://github.com/pamagister/mbox_converter`
